  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td colspan="4" class="news"><b>Revue der einzelnen Galawettbewerbe</b>
        <br />
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">Regensburg, 4. Juni 2007 (orv) – Auch die Domspitzmilch Gala 2007 wird in Richtung Europacup erneut eine zentrale Rolle spielen. Nachdem der DLV sein Team für die beiden Cup-Tage im Münchner Olympiastadion (23./24. Juni) am 11. Juni nominiert, ist Regensburg die letzte Möglichkeit sich zu qualifizieren. Viele deutsche Spitzenathleten/Innen werden diese Chance wahrnehmen. Wir wollen einen kleinen Überblick über die einzelnen Disziplinen geben.</font>
        </p>
        <table width="80%" border="0">

          <tr>
            <td width="55%"><a href="#m100">100 m Männer </a></td>
            <td width="45%"><a href="#f100">100 m Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m200">200 m Männer </a></td>
            <td><a href="#f200">200 m Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m400">400 m Männer</a></td>
            <td><a href="#f400">400 m Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m800">800 m Männer</a></td>
            <td><a href="#f800">800 m Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m1500">1500 m Männer</a></td>
            <td><a href="#f1500">1500 m Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m110h">110 m Hürden Männer</a></td>
            <td><a href="#f10000">10.000 m Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m400h">400 m Hürden Männer</a></td>
            <td><a href="#f100h">100 m Hürden Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m3000h">3000 m Hindernis Männer</a></td>
            <td><a href="#f3000h">3000 m Hindernis Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#m4x100">4x100 m Männer</a></td>
            <td><a href="#f4x100">4x100 m Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#mhoch">Hochsprung Männer</a></td>
            <td><a href="#fhoch">Hochsprung Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#mweit">Weitsprung Männer</a></td>
            <td><a href="#fweit">Weitsprung Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#mstab">Stabhochsprung Männer</a></td>
            <td><a href="#fstab">Stabhochsprung Frauen</a></td>
          </tr>
          <tr>
            <td><a href="#mkugelspeer">Kugel und Speer Männer</a></td>
            <td><a href="#fspeer">Speerwurf Frauen</a></td>
          </tr>
        </table>
        <p> </p>
        <p style="font-size: 12pt; font-weight: bold">Die Wettbewerbe der Männer</p>
        <a name="m100"></a>
        <p>
          <span style="font-style: italic">100 m Männer:</span>
          <br />
          <span style="font-weight: bold">Christian Blum fordert das deutsche Sprint-Establishment</span>
        </p>
        <p>
        ...
        <a name="m200"></a>
        <p>
          <span style="font-style: italic">200 m Männer:</span>
          <br />
          <span style="font-weight: bold">Tobias Unger will in Regensburg mehr</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
          ...
          weilen.</p>
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Tobias Unger </font>
        </p>
        <p> </p>
        <a name="m400"></a>
        <p>
          <span style="font-style: italic">400 m Männer:</span>
          <br />
          <span style="font-weight: bold">Was zeigt Viertelmeiler Bastian Swillims in der Freiluftsaison</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Ingo Schultz</font>
        </p>
        <p> </p>
        <a name="m800"></a>
        <p>
          <span style="font-style: italic">800 m Männer:</span>
          <br />
          <span style="font-weight: bold">Jason Stewart, der Lokalmatador gegen René Bauschinger und Steffen Co</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <a name="m1500"></a>
        <p>
          <span style="font-style: italic">1500 m Männer:</span>
          <br />
          <span style="font-weight: bold">Ein interessante Feld mit viel klasse, wenn man genau hinschaut</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <a name="m110h"></a>
        <p>
          <span style="font-style: italic">110 m Hürden Männer:</span>
          <br />
          <span style="font-weight: bold">Jens Werrmann, der EM-Sechste gibt sich die Ehre</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <a name="m400h"></a>
        <p>
          <span style="font-style: italic">400 m Hürden Männer:</span>
          <br />
          <span style="font-weight: bold">Schafft es Tomas Goller noch einmal</span>
        </p>
        <p>Die 400 m Hürdenläufer konnten zum Regensburger Leistungsboom des letzten Jahres damals weniger beitragen. 50,00 sind für sie immer noch eine harte Nuss. Und trotzdem, für einen Thomas Goller, der im Auf und Ab seiner langen Karriere als ganz Junger 2000 eine 48,81 und dann 2005 noch eine 49,61 lief, sollte das keine Unmöglichkeit sein, auch nicht die 49,26 der WM-Norm, sofern er gesund ist. Konkurrenz mit dem Südafrikaner Woter Le Roux (pB 49,25) hat er jedenfalls. Lars Birger Hense und Thomas Wieser, auch keine Schlechten in der deutschen Langhürdlerszene, wollen auch wieder einsteigen. Vieeleicht kommt auch noch der eine oder andere dazu, mit dem man auf dieser Strecke bisher gar nicht gerechnet hat.</p>
        <p> </p>
        <a name="m3000h"></a>
        <p>
          <span style="font-style: italic">3000 m Hindernis Männer:</span>
          <br />
          <span style="font-weight: bold">Die deutschen Hindernisläufer halten sich bedeckt</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <a name="m4x100"></a>
        <p>
          <span style="font-style: italic">4x100 m Männer:</span>
          <br />
          <span style="font-weight: bold">Die DLV-Staffel will die 38,80</span>
        </p>
        ...
        <a name="mhoch"></a>
        <p>
          <span style="font-style: italic">Hochsprung Männer:</span>
          <br />
          <span style="font-weight: bold">Roman Fricke gibt sich die Ehre</span>
        </p>
        <p>Eigentlich wollten die Hochspringer heuer gar nicht zur Gala kommen. Nun tut sich in dieser Disziplin aber doch was. Kein Geringerer als Roman Fricke, mit einer bisherigen Bestleistung von 2,30 notiert, gibt sich die Ehre, dahinter ein Feld von sechs bis sieben sicheren Zwei-Meter-Springern, für die 2,15 das Maß aller Dinge wären.</p>
        <p> </p>
        <a name="mweit"></a>
        <p>
          <span style="font-style: italic">Weitsprung Männer:</span>
          <br />
          <span style="font-weight: bold">Stepan Wagner (Tschechien) fordert Deutschlands einzigen Acht-Meter-Springer</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <a name="mstab"></a>
        <p>
          <span style="font-style: italic">Stabhochsprung Männer:</span>
          <br />
          <span style="font-weight: bold">Steven Lewis und die deutschen Quereinsteiger</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <p>
          <span style="font-style: italic">Kugel und Speer Männer:</span>
          <br />
          <span style="font-weight: bold">Peter Sack und Stefan Wenk auch dabei</span>
        </p>
        <p>Die Werfer werden am gleichen Wochenende ihre Hauptqualifikation für den Europacup in Schönebeck austragen. Deshalb erscheint eigentlich keine Wurf-/Stoßdisziplin im Gala-Programm. Um so mehr freuen wir uns, dass Deutschlands Kugelstoßer Nummer zwei Peter Sack (pB 20,83) und mit Stefan Wenk auch einer der besten deutschen Speerwerfer (pB. 83,94) nach Regensburg kommen.</p>
        <p> </p>
        <a name="f100"></a>
        <p style="font-weight: bold; font-size: 12pt">Die Wettbewerbe der Frauen</p>
        <p>
          <span style="font-style: italic">100 m Frauen:</span>
          <br />
          <span style="font-weight: bold">Verena Sailer oder doch schon wieder Sina Schielke</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Verena Sailer</font>
        </p>
        <p> </p>
        <a name="f200"></a>
        <p>
          <span style="font-style: italic">200 m Frauen:</span>
          <br />
          <span style="font-weight: bold">23,10 sind nicht unüberwindbar</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Sandra Möller</font>
        </p>
        <p> </p>
        <a name="f400"></a>
        <p>
          <span style="font-style: italic">400 m Frauen:</span>
          <br />
        ...
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Claudia Hoffmann </font>
          <br />
          <br />
        </p>
        <a name="f800"></a>
        <p>
          <span style="font-style: italic">800 m Frauen:</span>
          <br />
          <span style="font-weight: bold">Wehmut kommt auf, wenn man an Claudia Gesell denkt</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Jana Hartmann und Sibylle Dürrenmatt </font>
        </p>
        <p> </p>
        <a name="f1500"></a>
        <p>
          <span style="font-style: italic">1500 m Frauen:</span>
          <br />
          <span style="font-weight: bold">Denise Krebs ist in Regensburg noch immer Bestzeit gelaufen</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Denise Krebs </font>
        </p>
        <p> </p>
        <a name="f10000"></a>
        <p>
          <span style="font-style: italic">10.000 m Frauen:</span>
          <br />
          <span style="font-weight: bold">Fast wäre Mocki gekommen</span>
        </p>
        <p>Die Konstellation ist verrückt. Nach der Euro-Challenge und dem ungewollten Ausstieg, einer verwehten DM Anfang Mai und der folglich aufgetretenen Fragestellung „wo laufe ich nun meinen Leistungsnachweis für den DLV?“ kam für Sabrina Mockenhaupt
          nun wieder Regensburg ins Spiel. Im Grunde wollte Trainer Heiner Weber nur wieder die Möglichkeiten des letzten Jahres: ein gemischtes Rennen. Die internationalen Erfordernisse eines WM-Starts hat sie als EM-Achte bereits erfüllt. Den nationalen Leistungsnachweis sollte sie unter Regensburger Verhältnissen einsacken. Der DLV wollte schon auf Grund der derzeitigen Diskussionen um gemischte Rennen sein o.k. drunter setzen. Ansonsten ist das Rennen mit der Polin Karolina Jarzynska (33:48), der Schwäbin Stephanie Beckmann (33:54) und der Schweizerin Deborah Büttel (34:09) gut besetzt. Es kann gut sein, dass die fünfmalige Senioren-Europameisterin und Lokalmatadorin, inzwischen 46-jährig die integrierten Landesmeisterschaften gewinnt.</p>
        <p> </p>
        <a name="f100h"></a>
        <p>
          <span style="font-style: italic">100 m Hürden Frauen:</span>
          <br />
          <span style="font-weight: bold">Wer ist hinter Kirsten Bolm die Nummer zwei?</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <a name="f3000h"></a>
        <p>
          <span style="font-style: italic">3000 m Hindernis Frauen:</span>
          <br />
          <span style="font-weight: bold">Heimspiel für Susi Lutz</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <a name="f4x100"></a>
        <p>
          <span style="font-style: italic">4x100 m Frauen:</span>
          <br />
          <span style="font-weight: bold">Die DLV-Staffel kann beruhigt antreten</span>
        </p>
        <p>Die deutschen Sprinterinnen haben die Staffelnorm in Weinheim shon einmal abgehakt Bei guten Bedingungen und guten Wechseln könnte durchaus vor dem Komma eine „2“ für eine hohe 42er-Zeit stehen. Das wäre schon hoher europäischer Anspruch und wohl bei einer Wiederholungstat in Osaka der sichere Endlaufplatz.</p>
        <p> </p>
        <a name="fhoch"></a>
        <p>
          <span style="font-style: italic">Hochsprung Frauen:</span>
          <br />
          <span style="font-weight: bold">Was kann Daniela Rath nach der Babypause</span>
        </p>
        <p>Kirchheim. Es hatt sich aber wohl herumgesprochen, dass die Regensburger Anlage so schlecht nicht sein kann, wenn die beiden besten Leistungen des Vorjahres exakt von der Gala 06 stammen. So verwundert es dann auch nicht, dass sich auf der Meldeliste mit der Slowakin Diana Laznickova erneut eine Springerin von dieser Güte (pB. 1,91) steht. Kann die ebenfalls gemeldete Daniela Rath nach ihrer Babypause da schon wieder gegenhalten. Schließlich war sie vor Jahren einmal eine der wenigen deutschen Zwei-Meter-Springerinnen. Wenn Lokalmatadorin Karin Ertl auch hier antritt, muss sie sich mit der Uerdingerin Kathrin Tasche (p.B.1,84) auseinandersetzen.</p>
        <p> </p>
        <a name="fweit"></a>
        <p>
          <span style="font-style: italic">Weitsprung Frauen:</span>
          <br />
          <span style="font-weight: bold">Martina Darmovzalova ist die Favoritin</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
        ...
        <p>
          <font size="1" face="Arial, Helvetica, sans-serif" class="note">Foto: Kathrin van Bühren </font>
        </p>
        <p> </p>
        <a name="fstab"></a>
        <p>
          <span style="font-style: italic">Stabhochsprung Frauen:</span>
          <br />
          <span style="font-weight: bold">Eine Paradedisziplin des DLV stellt sich erneut in voller Stärke vor</span>
        </p>
        <p>
          <font face="Arial, Helvetica, sans-serif" size="2">
