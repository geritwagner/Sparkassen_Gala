...
?>
  ...
  <head>
    <title>
      <?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2018</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Sparkassen Gala 2018, Sparkassen-Gala, German Meeting, Regensburg, Leichtathletik, Top-Meeting, Leichtathletik-Elite, Sprint, Hindernis, Hürden" />
    ...
    <div id="page_margins">
      <div id="page">
        <div id="header">
          ...
          <div id="flashHeader">
            <img src="../images/design/header2018.jpg" width="900" height="245" alt="Sparkassen Gala 2018" />
          </div>
        </div>
        ...
        <div id="main">
          ...
          <div id="col1">
            <div id="col1_content" class="clearfix">
              ...
              <p>
                <strong>Laufnacht:
                  <br>Samstag, 02. Juni 2018</strong>
              </p>
              <h4>Sponsoren</h4>
              <br />
