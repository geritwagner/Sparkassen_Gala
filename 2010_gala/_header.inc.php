...
?>
  ...
  <head>
    <title>
      <?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2010</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Sparkassen Gala 2010, Sparkassen-Gala, German Meeting, Regensburg, Leichtathletik, Top-Meeting, Leichtathletik-Elite, Sprint, Hindernis, Hürden" />
    ...
    <div id="page_margins">
      <div id="page">
        <div id="header">
          ...
          <div id="flashHeader">
            <img src="images/design/header.png" width="900" height="245" alt="Sparkassen Gala 2010" />
          </div>
        </div>
                ...
                <li<? if($m=='news' ) echo $mA; ?>><a href="news/">News</a>
                  <ul>
                    ...
                    <li><a href="">Video-Highlights   »</a>
                      <ul id="navImpressionen">
                        <li><a href="http://videos.lg-telis-finanz.de/2010/sparkassen-gala/" target="_blank">Komplettes Archiv</a></li>
                    ...
                    <li><a href="http://videos.lg-telis-finanz.de/2010/sparkassen-gala/" target="_blank">Livestream-Aufzeichnung</a></li>
                  </ul>
                  </li>
        ...
        <div id="main">
          ...
          <div id="col3">
            <div id="col3_content" class="clearfix">
              ...
              <h4 class="hinweis" style="text-align:center;"><a href="http://www.sparkassen-gala.de/" target="_blank">» Webseite der Sparkassen Gala 2011</a></h4>
              <br />
