...
<head>
<title><?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2013</title>
...
<!-- Besonderes	-->
<h4 class="hinweis" style="text-align:center;"><a href="live-stream.php">&raquo; Videos</a>, <a href="ergebnisse.php">&raquo; Ergebnisse</a> und <a href="news/impressionen-kiefner.php">&raquo; Foto-Galerie</a> sind online</h4>
<br />
