...
?>
  ...
  <head>
    <title>
      <?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2013</title>
                              ...
                              <li<? if($m=='rueckblick' ) echo $mA; ?>><a href="rueckblick/">Rückblick</a>
                                ...
                                <li<? if($m=='sponsoren' ) echo $mA; ?>><a href="sponsoren/">Sponsoren</a></li>
                                  <li<? if($m=='english' ) echo $mA; ?>>
                                    <a href="http://www.sparkassen-gala.de/download/Sparkassen%20Gala%202013_english.pdf" target="blank">
        ...
        <div id="main">
          ...
          <div id="col3">
            <div id="col3_content" class="clearfix">
              ...
              <br />
              <!-- Besonderes	-->
              <h4 class="hinweis" style="text-align:center;"><a href="live-stream.php">» Videos</a>, <a href="ergebnisse.php">» Ergebnisse</a> und <a href="news/impressionen-kiefner.php">» Foto-Galerie</a> sind online</h4>
              <br />
