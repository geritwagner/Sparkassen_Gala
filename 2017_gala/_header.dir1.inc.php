...
?>
  ...
  <head>
    <title>
      <?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2017</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Sparkassen Gala 2017, Sparkassen-Gala, German Meeting, Regensburg, Leichtathletik, Top-Meeting, Leichtathletik-Elite, Sprint, Hindernis, Hürden" />
    ...
    <div id="page_margins">
      <div id="page">
        <div id="header">
          ...
          <div id="flashHeader">
            <img src="../images/design/header.jpg" width="900" height="245" alt="Sparkassen Gala 2017" />
          </div>
        </div>
        ...
        <div id="main">
          ...
          <div id="col1">
            <div id="col1_content" class="clearfix">
              ...
              <p>
                <strong>Laufnacht:
                  <br>Samstag, 10. Juni 2017</strong>
              </p>
              <h4>Sponsoren</h4>
              <br />
