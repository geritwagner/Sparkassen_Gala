...
?>
  ...
  <head>
    <title>
      <?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2014</title>
                              ...
                              <?php require("rueckblick_alle.php"); ?>
                                ...
                                <li<? if($m=='sponsoren' ) echo $mA; ?>><a href="sponsoren/">Sponsoren</a></li>
                                  <li<? if($m=='english' ) echo $mA; ?>>
                                    <a href="http://www.sparkassen-gala.de/download/Sparkassen%20Gala%202014_english.pdf" target="blank">
        ...
        <div id="main">
          ...
          <div id="col1">
            <div id="col1_content" class="clearfix">
              ...
              <br />
              <p>
                <strong>Laufnacht (<a target="_blank" href="http://www.lg-telis-finanz.de/2014_ausschreibungen/06-06_laufnacht.pdf">Infos</a>):
                  <br>Freitag, 6. Juni 2014</strong>
              </p>
              <h4>Sponsoren</h4>
          ...
          <div id="col3">
            <div id="col3_content" class="clearfix">
              ...
              <br />
              <!-- Besonderes	-->
              <h4 class="hinweis" style="text-align:center;"><a href="ergebnisse.php">»Ergebnisliste</a> <a target="_blank" href="http://www.leichtathletik.tv/index.php/events/view/id/3663">»Highlight Videos</a> und <a target="_blank" href="http://www.live.mittelbayerische.de/Event/Gipfeltreffen_der_Leichtathleten">»Der Tag im Blog</a>                sind online</h4>
              <br />
