<?php $title = "Live-Stream";
 $menu['current'] = "livestream"; ?>
  <?php require("_header.inc.php"); ?>
    ...
    <h2>Highlights der Sparkassen Gala 2014</h2>
    <br/> Die Highlights von leichtathletik.tv gibt es <a href="http://www.leichtathletik.tv/index.php/events/view/id/3663" target="_blank">»hier</a>.
    <br>
    <br>
    <br>
