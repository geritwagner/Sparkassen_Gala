...
?>
  ...
  <head>
    <title>
      <?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2011</title>
...
<br />	-->
              ...
              <h4 class="hinweis" style="text-align:center;"><a href="http://videos.lg-telis-finanz.de/2011/sparkassen-gala/" target="_blank">» Aufzeichnung der Sparkassen Gala online</a></h4>
              <br />
