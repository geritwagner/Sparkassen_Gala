<?php $title = "Berichte";
 $menu['current'] = "news"; ?>
  <?php require("../_header.dir1.inc.php"); ?>
    ...
    <p>
      <img class="float_left" title="Nico Sonnenberg (Foto: Kiefner)" src="../photos/kiefner/Sonnenberg_Nico-kiefner.jpg" alt="Nico Sonnenberg (Foto: Kiefner)" width="230" />Regensburg, 05. Juni 2015 (leichtathletik.de) - Der Frankfurter nahm trotz der hochsommerlichen Temperaturen auf den 3.000 Meter Hindernis das Heft in die Hand und eilte forsch vorne weg. Die klare Führung verteidigte der 23-Jährige auch bis zum Schluss. Im Alleingang verbesserte er bei diesem couragierten Auftritt seine Bestzeit auf 8:44,33 Minuten. Sein Ziel, die Norm für die Universiade, verpasste er trotzdem um rund zehn Sekunden: „Am Ende haben ein starker Gegner und auch die Kraft gefehlt. Ich weiß, ich kann läuferisch mehr. Ich brauche möglichst viele Rennen.“ Als Zweiter des Laufs unterbot der Ochsenfurter Patrick Karl mit einer Zeit von 8:52,18 Minuten die U20-EM-Norm von 9:02,00 Minuten deutlich. „Das Ergebnis war sehr gut, das Rennen aber gar nichts“, sagte Deutsche U20-Vize-Meister selbstkritisch. Er kämpfte nicht nur mit einer Allergie, sondern hatte auch Rhythmusprobleme: „Ich musste vor jedem Hindernis trippeln.“ Entsprechend Potenzial sieht er noch für die nächsten Wochen: „Spätestens bei der U20-EM wird die Bestzeit fallen.“<a href="http://www.leichtathletik.de/news/news/detail/nico-sonnenberg-im-alleingang-zur-bestzeit/" target="_blank">» Hier</a> geht's weiter ...</p>
    <br />
