		...
		<div id="nav">
			...
			<div id="nav_main">
				<ul class="adxm menu">
				  ...
				  <li<? if($m == 'english') echo $mA; ?>><a href="download/sparkassen_gala_2015_english.pdf" target="blank"><img src="images/design/british-flag.jpg"></img></a></li>
				</ul>
			</div>
		</div>
		<!-- end: main navigation -->
...
<!-- Besonderes	-->
<h4 class="hinweis" style="text-align:center;"><!--<a href="livestream-popup.php" target="_blank">&raquo;Live-Stream</a> und --><a href="../ergebnisse.php">&raquo;Live Ergebnisse</a> und <a href="news/impressionen-kiefner.php">&raquo;Kiefner Impressionen 1. Tag</a> sind online</h4>
<br />
