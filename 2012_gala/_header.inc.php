...
?>
  ...
  <head>
    <title>
      <?php if (!empty($title)) echo $title." - "; ?>Sparkassen Gala 2012</title>
                              ...
                              <li<? if($m=='rueckblick' ) echo $mA; ?>><a href="rueckblick/">Rückblick</a>
                                ...
                                <li<? if($m=='sponsoren' ) echo $mA; ?>><a href="sponsoren/">Sponsoren</a></li>
                                  <li<? if($m=='english' ) echo $mA; ?>>
                                    <a href="download/Sparkassen Gala 2012_eng.pdf" target="blank">
        ...
        <div id="main">
          ...
          <div id="col3">
            <div id="col3_content" class="clearfix">
              ...
              <br />
              <!-- Besonderes	-->
              <h4 class="hinweis" style="text-align:center;"><a href="http://www.sparkassen-gala.de/live-stream.php">» Highlight-Videos und alle Videos des Hauptprogramms sind online</a></h4>
              <br />
